  ...
  <div class="add-admin col-12 bg-white">
    <form id="save-employee-form" action="{{ route('employees.store') }}" class="pt-5 px-md-3" method="post">
      ...
      <div class="form-group row mb-4 px-3">
        ...
        <input id="name" name="name" type="text" class="form-control" placeholder="Masukkan Nama nakes" required>
      </div>
      <div class="form-group row mb-4 px-3">
        <label for="email" class="form-label col-md-3">Email</label>
        <input id="email" name="email" type="email" class="form-control" placeholder="Masukkan Email nakes" required>
      </div>
      <div class="form-group row mb-4 px-3">
